    ...
    <div class="wrapper">
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                //Image button (Checking and Uploading Image if selected)

                if(isset($_FILES['image']['name']))
                {
                    $image_name = $_FILES['image']['name'];
                    //Checking Image if Selected, Uploads Image when Selected
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "Product_Name_".rand(000,999).".".end($ext);
